...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
   ...
   $update_quantity="UPDATE blood_type SET quantity='$quantity' where blood_id='$blood_id'";
					...
					<div class="card" style="box-shadow: 0 0 0px rgb(0 0 0) !important;">
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									<input type="submit" class="btn btn-primary px-4" value="update changes"  required>
								</div>
							</div>
						</div>
						</form>
