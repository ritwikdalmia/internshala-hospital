...
?>
    ...
    <?php
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `admin_internshala` ( `admin_username`, `hospital_name`,`email`,`password`,`token`,`creation_time`) VALUES ('$admin_username','$hospital_name','$email','$hash','$token','$timestamp')";
...
$subject = "hospital Verification Code";
                                        ...
                                        <tr>
                                            <td align='center' style='color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;'
                                                ...
                                                <div style='line-height: 35px'>
                                                    ...
                                                    Welcome to  <span style='color: #FF0000;'>Tech Wizard Blood Management Systemm ".$hospital_name."</span>
                                                    ...
                                                    <tr>
                                                        <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                                            ...
                                                            <div style='line-height: 24px'>
                                                               ...
                                                               Thank you for registering !!! Verification code is  ".$token." and  Ip address is ".$ip_address."  at time ".$timestamp." <br>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                    ...
                    <table border='0' align='center' width='50%' cellpadding='0' cellspacing='0' bgcolor='#FF0000'>
                        <tr>
                            <td height='25' style='font-size: 25px; line-height: 25px;'>&nbsp;</td>
                        </tr>
                        <tr>
                                            ...
                                            <table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>
                                                ...
                                                <tr>
                                                            <td align='left' style='color: black; font-size: 20px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'
                                                                class='align-center'>            
                                                                <div style='line-height: 24px'>
                                                                    <strong>Login Username:</strong><br><p> ".$admin_username."</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
    ...
    if($showAlert1){
        ...
        if(count($errors) == 1){
                 ...
                 ?>
							...
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">Hospital full Name</h6>
								</div>
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" placeholder="Enter your hospital name" name="hospital_name" id="hospital_name" required>
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control"   name="admin_username" id="admin_username" placeholder="Enter admin login username"  required>
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									<input type="submit" class="btn btn-primary px-4" value="Register Now">
