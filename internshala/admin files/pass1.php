...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql_email = "SELECT * FROM `admin_internshala` WHERE email = '$email'";
    ...
    $sql = "UPDATE admin_internshala SET password_token='$password_token',password_verification=0 WHERE email='$email'";
