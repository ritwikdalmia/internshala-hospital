...
<?php include 'nav.php';?>
    ...
    $select_display="select  * from application_request where acceptance='pending' and hospital_name='$hospital_name' order by application_request_id asc  " ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        <div><br><br></div>";
        echo" <a class='btn btn-primary' href='approved.php?application_request_id=$application_request_id'>approve</a>
        ";
...
";
				...
				<p>if nothing is shown no application request received
        </p>
		</div>
	 </div>
    </div>
